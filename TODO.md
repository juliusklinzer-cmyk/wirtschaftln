...
- [x] **Kasse überarbeitet (19.07.):** Zeremonie-Kopf (Rauten-Band, Kassenwart-Zeile), „D'Maßeinheit"-Karte mit Bräustüberl-Speisekarten-Link + 3,70-€-Preis, 💝 Spenden-Klappe (jeder, für sich selbst), Ausgaben nur Kassenwart/Admin (Server + UI), alle Aktionen als ErfolgsKlappe (Erfolgsmeldung + auto-zu); Runde gschmissen = Teilnehmer × 3,70 € als Wert im Kassenbuch (gold, zählt NICHT in den Saldo — wird ja am Tisch zahlt)
